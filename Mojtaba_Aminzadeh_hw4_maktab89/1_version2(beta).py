...
class User:
    ...
    def change_password(user):
        ...
        while True:
            ...
            if _old_password != user.__password:
                input(f'> {"your old password incorrect. press Enter for try again" }')
                continue
            ...
            if _new_password_1 != _new_password_2:
                input(f'''> {"your new password don't match. press Enter for try again"}''')
                continue
    ...
    def edit_username_and_phone(self):
        print('========== endit username and phone ==========\n')
        ...
        _phone_number = input(f'> new phone number: [leave empty for {self.phone_number}]\n'
                              f'  or type {"remove"} for remove your phone number: ')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if op:
            ...
            input(f'> {"invalid input, press Enter to continue..."}')
